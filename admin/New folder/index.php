...
FROM (
    ...
    WHERE MONTH(od.over_date) = MONTH(CURRENT_DATE())
      AND YEAR(od.over_date) = YEAR(CURRENT_DATE()) AND od.over_status = 3
    ...
    WHERE MONTH(o.order_date) = MONTH(CURRENT_DATE())
      AND YEAR(o.order_date) = YEAR(CURRENT_DATE()) AND o.status = 3
) AS subquery";
            ...
            <div class="overview-content w-100">
              <div class=" ap-po-details-content d-flex flex-wrap justify-content-between" style="background-color: rgba(206, 201, 0, 0.59); ">
                <div class="ap-po-details__titlebar">
                  ...
                  <h2 class="text-white">
                    <span class="text-white"><?php echo number_format($totalSum, 2); ?> </span>
